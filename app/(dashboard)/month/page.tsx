...
export default function MonthPage() {
  ...
  const { events, refetch } = useCalendarEvents({ from: gridStart, to: gridEnd })
  ...
  return (
    <div className="flex flex-col h-full p-1 sm:p-2">
      ...
      <div className="grid grid-cols-7 mb-1">
        {WEEKDAYS.map((d, i) => (
          <div key={d} className="text-center text-[10px] sm:text-xs text-slate-500 py-1">
            ...
            {week.map(day => {
              ...
              return (
                <button
                  ...
                  className={`
                    relative flex flex-col p-0.5 sm:p-1 rounded-md sm:rounded-lg text-left min-h-[48px] sm:min-h-[70px] transition-colors
                ...
                >
                  ...
                  <div className="hidden sm:flex flex-col gap-0.5 mt-1 overflow-hidden flex-1">
                  ...
                  {dayEvents.length > 0 && (
                    <div className="flex gap-0.5 mt-auto pt-0.5 sm:hidden">
